"""ssuetstudentprofile_20975 URL Configuration
...
admin.site.site_header = "SSUETSTUDENTPROFILE"
admin.site.site_title = "SSUETSTUDENTPROFILE Admin Portal"
admin.site.index_title = "SSUETSTUDENTPROFILE Admin"

# swagger
api_info = openapi.Info(
    title="SSUETSTUDENTPROFILE API",
    default_version="v1",
    description="API documentation for SSUETSTUDENTPROFILE App",
)
